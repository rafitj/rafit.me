      ...
      <div id="home">
        <div className="home_container">
          ...
          >
            ...
            <Card
              onClick={() => this.openInNewTab('mailto: rafit.jamil@gmail.com')}
              width={125}
            >
              📫 Email
            </Card>
            <Card
              onClick={() => this.openInNewTab('http://github.com/rafitj')}
              width={125}
            >
              💻 Github
            </Card>
            <Card
              onClick={() =>
                this.openInNewTab('https://www.linkedin.com/in/rafitj')
              }
              width={125}
            >
              💼 LinkedIn
