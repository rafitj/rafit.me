  ...
  render() {
    return (
      <div className='section'>
        ...
        <Space size="large" style={{display: "flex", margin: '0 auto', flexWrap: "wrap", width: "75%", justifyContent: "center"}}>
        <ExpCard img={amz} title="Amazon" desc="Incoming Software Engineering Intern" loc="Vancouver"
            details="Computational geometry and 3D rendering"
            date="Jul 2021 - Oct 2021"
            color="#FE9401"
            link="www.amazon.com"
          />
        <ExpCard img={salesforce} title="Salesforce" desc="Software Engineering Intern" loc="San Francisco Bay Area"
            details="Standalone runtimes and app frameworks for SF Lightning"
            date="May 2021 - Jul 2021"
            color="#009FDF"
            link="https://www.salesforce.com/ca/campaign/lightning/"
          />
          <ExpCard img={meter} title="Meter" desc="Software Engineering Intern" loc="San Francisco Bay Area"
            details="Did some computational geometry, 3D rendering and scan reconstruction stuff"
            date="Aug 2020 - Dec 2020"
            color="white"
            link="https://meter.parts/"
          />
          <ExpCard img={setter} title="Setter" desc="Software Engineering Intern" loc="Toronto"
            details="Got really good at fullstack apps, microservices and CI/CD"
            date="Jan 2020 - May 2020"
            color="#FF2D4F"
            link="https://setter.com/"
          />
          <ExpCard img={mlse} title="MLSE" desc="Software Engineering Intern" loc="Toronto"
