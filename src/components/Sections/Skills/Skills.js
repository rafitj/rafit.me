...
import apollo from "../../../assets/images/tools/apollo.svg";
...
class Skills extends Component {
  ...
  getFilterClass = f => {
    return (
      "tool_filter " + (this.state.filter === f ? " selected_filter" : " ")
    );
  };
  updateDimensions = () => {
  ...
  render() {
    const tools = [
      ...
      { name: "Apollo", type: "JavaScript", tool: "apollo", img: apollo },
